...
<div class="form-body">    
    ...
    <div class="form-group {!! APFrmErrHelp::hasError($errors, 'degree_level_id') !!}" id="degree_level_id_div">
        ...
        ?>
        <!-- {!! Form::select('degree', $degreeLevels, $degree, array('class'=>'form-control select2', 'id'=>'degree')) !!} -->
    ...
    <div class="form-group {!! APFrmErrHelp::hasError($errors, 'job_experience_id') !!}">
        ...
        {!! Form::text('job_experience_id', null, array('class'=>'form-control', 'id'=>'job_experience_id', 'placeholder'=>'Enter Job Experience')) !!}
