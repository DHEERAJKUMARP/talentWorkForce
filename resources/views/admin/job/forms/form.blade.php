...
{!! Form::hidden('id', null) !!}
    ...
    <div class="form-group" id="state_id_div">
 ...
 -->        {!! Form::label('city_id', 'City', ['class' => 'bold']) !!}                    
    ...
    <div class="form-group" id="functional_area_id_div">
        ...
        {!! Form::text('functional_area_id', null, array('class'=>'form-control', 'id'=>'functional_area', 'placeholder'=>'Enter Functional Area')) !!}                   
    ...
    <div class="form-group" id="job_type_id_div">
    ...
    <div class="form-group {!! APFrmErrHelp::hasError($errors, 'degree_level_id') !!}" id="degree_level_id_div">
        ...
        <?php
        $degree = old('degree', $degreeLevels);
        ?>
        <!-- {!! Form::select('degree[]', $degreeLevels, $degree, array('class'=>'form-control select2-multiple', 'id'=>'degree', 'multiple'=>'multiple')) !!} -->
    ...
    <div class="form-group" id="job_experience_id_div">
        <!-- <div class="form-group {!! APFrmErrHelp::hasError($errors, 'job_experience_id') !!}" id="job_experience_id_div"> -->
        {!! Form::label('job_experience_id', 'Enter job experience', ['class' => 'bold']) !!}                    
        ...
        {!! Form::text('job_experience_id', null, array('class'=>'form-control', 'id'=>'job_experience_id', 'placeholder'=>'Enter Job Experience Area')) !!}  
...
<script type="text/javascript">
    ...
    //     });
         $(document).ready(function () {
        $('.select2-multiple').select2({
            placeholder: "Select Required Details",
            allowClear: true
        });
