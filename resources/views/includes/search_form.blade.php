...
<h3 class="seekertxt">{{__('One thousand success stories')}}. <span>{{__('Search Jobseekers Today')}}.</span></h3>
...
@else
<h3>{{__('One thousand success stories')}}. <span>{{__('Start yours today')}}.</span></h3>
