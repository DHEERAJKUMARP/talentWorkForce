<div class="header">
    <div class="container-fluid">
        <div class="row">
            <div class="col-lg-1 col-md-8 col-8"> <a href="{{url('/')}}" class="logo"><img
            ...
            <!--        <li style="font-weight: bold;padding-top: 15px;">Applicants: {{getActiveUsers()['totalActiveUsers']}}</li>-->
            <!--    </ul>-->
            <!--</div>-->

            <div class="col-lg-1 col-md-8 col-8" style="padding-left: 40px;">
                <ul class="navbar-nav ml-auto">
                    <li style="font-weight: bold;padding-top: 15px;">Employers: {{getActiveUsers()['totalEmployers']}}</li>
                </ul>
            </div>
                ...
                <nav class="navbar navbar-expand-lg navbar-light">
                    ...
                    <div class="navbar-collapse collapse" id="nav-main">
                        <ul class="navbar-nav ml-auto">
                            ...
                            <li class="nav-item dropdown userbtn"><a
                                ...
                                <ul class="dropdown-menu">
                                    ...
                                    <li class="nav-item"><a href="{{ route('post.job') }}" class="nav-link"><i
                                                class="fa fa-desktop" aria-hidden="true"></i> {{__('Post Job')}}</a>
                                    </li>
                            ...
                            <li class="nav-item"><a href="{{route('login')}}" class="nav-link">{{__('Sign in')}}</a>
                            </li>
