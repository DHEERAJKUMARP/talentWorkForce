                    ...
                    <div class="tab-content">
                        ...
                        <div id="candidate" class="formpanel tab-pane {{($c_or_e == 'candidate')? 'active':''}}">
                            ...
                            <form class="form-horizontal" method="POST" action="{{ route('register') }}">
                                ...
                                <div class="formrow{{ $errors->has('mobile_num') ? ' has-error' : '' }}">

                                    <input type="text" name="mobile_num" class="form-control" required="required" placeholder="{{__('Mobile Number')}}" value="{{old('mobile_num')}}">

                                    @if ($errors->has('mobile_num')) <span class="help-block"> <strong>{{ $errors->first('mobile_num') }}</strong> </span> @endif </div>
                        ...
                        <div id="employer" class="formpanel tab-pane fade {{($c_or_e == 'employer')? 'active':''}}">
                            ...
                            <form class="form-horizontal" method="POST" action="{{ route('company.register') }}">
                                ...
                                <div class="formrow{{ $errors->has('name') ? ' has-error' : '' }}">
                                    ...
                                    <input type="text" name="name" class="form-control" required="required" placeholder="{{__('Company Name')}}" value="{{old('name')}}">
                                ...
                                <div class="formrow{{ $errors->has('ceo') ? ' has-error' : '' }}">
                                    ...
                                    <input type="text" name="ceo" class="form-control" required="required" placeholder="{{__('Conact Person Name')}}" value="{{old('ceo')}}">

                                    @if ($errors->has('ceo')) <span class="help-block"> <strong>{{ $errors->first('ceo') }}</strong> </span> @endif 
                                </div>
