        ...
        <div class="contact-wrap">
            <div class="title"> <span>{{__('We Are Here For Your Help')}}</span>
				...
				<div class="row"> 
                    ...
                    <!-- Contact Info -->
                    <div class="col-lg-4 column">
                        <div class="contact"> <span><i class="fa fa-clock-o"></i></span>
                            <div class="information"> <strong>{{__('Office Timings')}}:</strong>
                                <p>{{__('10:00 AM to 07:00 PM')}}</a></p>
                            </div>
                        </div>
                    ...
                    <div class="col-lg-4 column">
                        <div class="contact"> <span><i class="fa fa-phone"></i></span>
                            <div class="information"> <strong>{{__('Primary Phone')}}:</strong>
                                <p><a href="tel:{{ $siteSetting->site_phone_primary }}">{{ $siteSetting->site_phone_primary }}</a></p>
                            </div>
                        </div>
                        <div class="contact"> <span><i class="fa fa-phone"></i></span>
                            <div class="information"> <strong>{{__('Secondary Phone')}}:</strong>
